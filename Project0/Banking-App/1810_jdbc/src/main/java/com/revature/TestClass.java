...
public class TestClass {
	...
	public static void main(String[] args) {
		...
		//System.out.println(CustomerService.getInstance().registerCustomer(new Customer(1, "Yuvaraj", "Damodaran", "yuvi", "1234")));
		...
		//System.out.println(CustomerService.getInstance().registerCustomerSecure(new Customer(2, "Using Stored", "Procedure", "storedproc", "storedproc")));
